...
export function FlavorModal({ isOpen, onClose, flavor }: FlavorModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-3xl overflow-hidden rounded-[32px] md:rounded-[24px] bg-paper shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-4 duration-300 h-[90vh] md:h-auto flex flex-col md:block z-[100]">
                ...
                <div className="hidden md:flex flex-row h-auto overflow-hidden">
                    ...
                    {/* Desktop Left: Image Side */}
                    <div className="relative flex-shrink-0 w-5/12 items-center justify-center bg-paper2 min-h-[500px]">
